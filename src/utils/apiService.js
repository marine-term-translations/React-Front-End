...
export const checkReviewerStatus = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/api/github/reviewer/status`,
    {
      params: {
        repo: REPO,
        branch: sessionStorage.getItem("branch"),
...
export const getFileReviewStatus = async () => {
  const response = await axios.get(
    `${API_BASE_URL}/api/github/reviewer/files`,
    {
      params: {
        repo: REPO,
        branch: sessionStorage.getItem("branch"),
...
export const submitFileReview = async (filename, approved) => {
  const response = await axios.post(
    `${API_BASE_URL}/api/github/reviewer/review`,
    {
      repo: REPO,
      branch: sessionStorage.getItem("branch"),
      filename: filename,
...
export const submitPRApproval = async () => {
  const response = await axios.post(
    `${API_BASE_URL}/api/github/reviewer/approve`,
    {
      repo: REPO,
      branch: sessionStorage.getItem("branch"),
    },
